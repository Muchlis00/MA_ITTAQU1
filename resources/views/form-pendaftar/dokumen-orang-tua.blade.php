...
['name'=> 'KTP Ayah',
'key' =>'father_ktp',
'value' => $currentWali->father->ktp],
['name'=> 'KTP Ibu',
'key' =>'mother_ktp',
'value' => $currentWali->mother->ktp],
['name'=> 'Kartu Keluarga',
'key' =>'kartu_keluarga',
'value' => $currentWali->father->kartu_keluarga],
];
@endphp
<form action="{{ route('formulir-ppdb.storeDokumenOrangTua') }}" method="POST" class="space-y-6" enctype="multipart/form-data">
    @csrf
