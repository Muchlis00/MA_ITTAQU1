        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white shadow-md rounded-lg p-6">
                <div class="flex justify-between">
                    <h2 class="text-2xl font-semibold mb-4">Tambah Jadwal Orientasi</h2>
                </div>
                <form action="{{ route('orientasi.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="keterangan" id="keterangan" class="mt-1 p-2 w-full rounded-md border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                    </div>
